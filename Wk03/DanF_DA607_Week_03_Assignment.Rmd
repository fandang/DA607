...
#### Pre Reqs:
* The table: __tb__ was created using prereq script: https://raw.githubusercontent.com/fandang/DA607/master/Wk03/tb.sql
* The __tb__ table was loaded with data from csv: https://raw.githubusercontent.com/fandang/DA607/master/Wk03/tb.csv
...
* After all of that, the following was done in R:
